...
// Usando "reduce"
function groupByCategory(arrayMovies){
    return arrayMovies.reduce((acc, movie)=>{
        // Recorremos todos los elementos del array y acumulamos el resultado "acc"
        ...
        return acc;
    }, {}); // Esti crea como valor inicial un objeto vacío
}
