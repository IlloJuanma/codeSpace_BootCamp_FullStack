...
/**
 * IMPORTANTE PARA LOS EJERCICIOS DEL 10 AL 15
 * PARA PODER VER LOS RESULTADOS POR CONSOLE LOG, USANDO QUOKKA, COPIAR Y PEGAR LA CONST MOVIES
 * DEL DATA.JS EN CADA EJERCICIO PARA PODER LEERLO, QUOKKA NO PERMITE SACAR EL RESULTADO DE UN ARCHIVO
 * EXTERNO
 */
export const movies = [
    {
...
function movieSortedByTitle(arrayMovies){
    // map para extraer solo los titulos y sort para ordenarlos alfabéticamente
    return arrayMovies.map(movie=> movie.title).sort();
}

const sortedMovies = movieSortedByTitle(movies);
